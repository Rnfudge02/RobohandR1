...
/**
 * @defgroup i2c_sensor_adapter_enum I2C Sensor Adapter Enumerations
 * @{
 */
...
/** @} */ // end of i2c_sensor_adapter_enum group

/**
 * @defgroup i2c_sensor_adapter_struct I2C Sensor Adapter Data Structures
 * @{
 */
...
/** @} */ // end of i2c_sensor_adapter_struct group

/**
 * @defgroup i2c_sensor_adapter_api I2C Sensor Adapter Application Programming Interface
 * @{
 */
